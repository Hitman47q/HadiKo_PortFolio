...
const API_URL = window.location.hostname === 'localhost'
  ...
  : 'https://portfolio-api.gamerhadi44.workers.dev/api'
...
function App() {
  ...
  useEffect(() => {
    ...
    // Nav background toggle — driven by scroll PROGRESS through the stage,
    // not a fixed pixel value, so it works the same on any screen height.
  ...
  const typeLabels = {
    web_app: 'Web app',
    video_production_reel: 'Video production reel',
    ...
    <link href="https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,400;0,9..144,500;0,9..144,600;1,9..144,500&family=Sora:wght@300;400;500;600&display=swap" rel="stylesheet" />
      ...
      <section className="scroll-stage" id="stage" ref={stageRef}>
        <div className="sticky" id="sticky">
          ...
          <div className="copy" id="copy" ref={copyRef}>
            ...
            <div className="role">FULL-STACK DEVELOPER
              <br />Flutter engineer . Video editor</div>
            <p className="desc">I design and build the whole thing - the backend, the app, the reel that shows it off, turning ideas into interactive reality.</p>
            <a className="cta" href="#work">EXPLORE MY WORK <b>→</b></a>
          </div>
          ...
          <div className="micro follow">FOLLOW ME</div>
          <div className="scroll-label">SCROLL TO BREAK THROUGH<div className="scroll-line"></div></div>
          <div className="next-section" id="next" ref={nextRef}>01 / ABOUT ME</div>
        </div>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="container intro-grid">
          <p className="intro-lede">Building things that feel as good as they work.</p>
          <div className="intro-body">
            <p>I'm Hadi, a <strong>developer</strong> who also <strong>edits video</strong>, which turns out to be a useful combination. Most portfolios pick <strong>one skill</strong> and lean on it — mine is built from <strong>three</strong>, because that's genuinely how I work.</p>
            <p>Day to day that means shipping full-stack web apps end to end, building Flutter apps that feel native on both platforms, and editing the launch videos, demo reels, and social cuts that get the work in front of people.</p>
            <div className="stat-row">
              <div className="stat"><div className="num">3+</div><div className="lbl">Years building products</div></div>
              <div className="stat"><div className="num">20+</div><div className="lbl">Projects shipped</div></div>
              <div className="stat"><div className="num">3</div><div className="lbl">Disciplines, one workflow</div></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-pad" id="services">
        <div className="container">
          <div className="tag2">02 — What I do</div>
          <div className="section-head">
            <h2>Three skills, one person to call.</h2>
            <p>Pick the piece you need, or hand over the whole project — planning, build, and the video that explains it.</p>
          </div>
          <div className="services-list">
            <div className="service-row">
              <div className="service-name"><span className="swatch" style={{ background: 'var(--accent)' }}></span>Full-stack development</div>
              <div className="service-desc">
                <p>Web applications built end to end — databases, APIs, and the interface people actually touch. I favor simple, fast, maintainable systems over clever ones.</p>
            ...
            <div className="service-row">
              <div className="service-name"><span className="swatch" style={{ background: 'var(--accent-2)' }}></span>Flutter app development</div>
              <div className="service-desc">
                <p>One codebase, native feel on iOS and Android. From first wireframe to an app-store-ready build, with animation and state handled properly rather than bolted on.</p>
                <div className="chip-row">
            ...
            <div className="service-row">
              <div className="service-name"><span className="swatch" style={{ background: '#d97a9c' }}></span>Video editing</div>
              <div className="service-desc">
                <p>Product demos, launch trailers, and social cuts. I edit the way I code — with a clear structure first, then polish on top of it.</p>
                <div className="chip-row">
      ...
      <section className="work section-pad" id="work">
        <div className="container">
          <div className="tag2">03 — Selected work</div>
          <div className="section-head">
            <h2>A few things I've shipped.</h2>
            <p>Let me know what you think — Click to see the full work.</p>
          </div>
                ...
                <div className="work-thumb" style={{ background: typeGradients[project.type] || typeGradients.web_app }}>
                  <img
                    src={window.location.hostname === 'localhost'
                      ...
                      : `/storage/${project.photo}`}
                    alt={project.name}
                    style={{ width: '100%', height: '100%', objectFit: 'cover' }}
                  />
                </div>
                <div className="work-body">
                  <div className="work-tag">{typeLabels[project.type] || project.type}</div>
                  ...
                  <a href={project.link} target="_blank" rel="noopener noreferrer" className="work-link">
                    {project.type === 'video_production_reel' ? 'Watch reel' : 'View case study'}
                  </a>
                </div>
              </div>
            ))}
      ...
      <section className="section-pad">
        <div className="container">
          <div className="tag2">04 — How a project runs</div>
          <div className="section-head">
            <h2>Three stages, no surprises.</h2>
          </div>
          <div className="process-grid">
            <div className="process-step">
              <div className="process-card">
                <div className="step-num">01</div>
                <h3>Scope it together</h3>
                <p>A short call to pin down what you actually need, a rough timeline, and a fixed quote — before any code is written.</p>
              </div>
            </div>
            <div className="process-step">
              <div className="process-card">
                ...
                <p>Regular check-ins with working previews, not silence until a big reveal. You see progress every week.</p>
              </div>
            </div>
            <div className="process-step">
              <div className="process-card">
                <div className="step-num">03</div>
                <h3>Ship and hand off</h3>
                <p>Deployed, documented, and — if it's a launch — cut into a video that explains it to your users or investors.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="contact" id="contact">
        <div className="container contact-inner">
          <div className="tag2" style={{ justifyContent: 'center' }}>05 — Get in touch</div>
          <h2>Have a project in mind? Let's talk about it.</h2>
          <a href="mailto:hello@bilalkhan.dev?subject=Project%20inquiry" className="contact-email">hadimc24@gmail.com</a>
        ...
        <div className="container foot">
          <span>&copy; 2026 Hadi Korish</span>
